...
function App() {
    ...
    // const addCoordinatesNewSchool = (e: any) => {
    //     const reg = /[^\d\.]/g
    //     setCoordinate(e.currentTarget.value.replace(reg, ''))
        ...
        <div className="App">
            <div className={'searchAddNavigation'}>
                ...
                <div className={'addObject'}>
                    ...
                    <div>
                        <div>координаты</div>
                        <input value={newSchoolLatitude} type={'text'} onChange={onChangeNewSchoolLatitudeHandler}/>

                        <input value={newSchoolLongitude} type={'text'} onChange={onChangeNewSchoolLongitudeHandler}/>
                    </div>
